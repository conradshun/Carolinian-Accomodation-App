    ...
    if (id) {
      const fetchServiceItem = async () => {
        try {
          ...
          setError("Failed to load service item details. Please try again later.")
        } finally {
          setIsLoading(false)
        }
      }
      ...
      <div className="min-h-screen bg-gradient-to-b from-green-900 via-green-800 to-green-700">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center bg-gradient-to-r from-green-800 to-green-700 p-8 rounded-xl shadow-lg border border-green-600">
            ...
            <p className="text-2xl text-green-100 mb-4">Service item not found.</p>
            ...
            <div className="p-6 md:w-1/2 relative">
              ...
              {serviceItem.description && (
                <div className="mb-6 bg-green-700 bg-opacity-50 p-4 rounded-lg border border-green-600 transform transition-all duration-300 hover:shadow-md hover:-translate-y-1">
                  ...
                  <p className="text-green-100">{serviceItem.description}</p>
                </div>
              )}
              ...
              {serviceItem.openHours && (
                <div className="mb-6 bg-green-700 bg-opacity-50 p-4 rounded-lg border border-green-600 transform transition-all duration-300 hover:shadow-md hover:-translate-y-1">
                  ...
                  <p className="text-green-100">{serviceItem.openHours}</p>
                </div>
              )}
                  ...
                  onClick={() => {
                    if (navigator.share) {
                      navigator.share({
                        ...
                        text: `Check out ${serviceItem.name} on Carolinian Accommodation App!`,
