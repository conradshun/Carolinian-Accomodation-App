...
export default function ServiceItemDetails() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-lime-700 via-lime-600 to-yellow-500 flex justify-center items-center">
        <div className="relative">
          <div className="w-20 h-20 border-4 border-green-700 border-t-green-900 rounded-full animate-spin"></div>
          <div className="absolute top-0 left-0 w-20 h-20 border-4 border-transparent border-t-green-800 rounded-full animate-spin-slow"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-green-900 font-medium">
            Loading
          </div>
        </div>
      </div>
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-lime-700 via-lime-600 to-yellow-500">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mt-6 flex justify-center">
            <Link
              href="/service_places/service_items"
  ...
  if (!serviceItem) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-lime-700 via-lime-600 to-yellow-500">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center bg-gradient-to-r from-lime-600 to-lime-500 p-8 rounded-xl shadow-lg border border-green-700">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-16 w-16 mx-auto mb-4 text-green-900"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
            ...
            <p className="text-2xl text-green-900 mb-4">Service not found.</p>
            <p className="text-green-800 mb-6">
              The service you're looking for may have been removed or doesn't exist.
            </p>
            <Link
              href="/service_places/service_items"
              className="bg-gradient-to-r from-green-700 to-green-600 text-yellow-300 px-6 py-3 rounded-full hover:from-green-600 hover:to-green-500 transition duration-300 inline-flex items-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5 mr-2"
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 backdrop-blur-xl bg-gradient-to-b from-lime-700 via-lime-600 to-yellow-500 bg-opacity-60"></div>
      ...
      <div className="relative container mx-auto px-4 py-8 z-10">
        ...
        <div className="bg-gradient-to-br from-lime-600 to-lime-500 rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-500 hover:shadow-2xl">
          <div className="md:flex">
            <div className="md:w-1/2 relative overflow-hidden group">
              {imageSrc ? (
                ...
                <div className="w-full h-64 md:h-full flex items-center justify-center bg-lime-700">
                  <span className="text-lime-300">No image available</span>
                </div>
              )}
              <div className="absolute inset-0 bg-gradient-to-t from-lime-700 to-transparent opacity-40"></div>
              <button
                onClick={() => toggleFavorite(Number.parseInt(id))}
                className="absolute top-4 right-4 p-3 bg-green-800 bg-opacity-80 rounded-full shadow-md hover:bg-opacity-100 transition-all transform hover:scale-110 hover:rotate-12 z-10"
            ...
            <div className="p-6 md:w-1/2 relative">
              {/* Decorative elements */}
              <div className="absolute -top-4 -right-4 w-20 h-20 bg-green-900 opacity-5 rounded-full"></div>
              <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-green-900 opacity-5 rounded-full"></div>

              <h1 className="text-4xl font-bold mb-4 text-green-900 animate-pulse-slow">{serviceItem.name}</h1>

              {serviceItem.description && (
                <div className="mb-6 bg-lime-500 bg-opacity-50 p-4 rounded-lg border border-green-700 transform transition-all duration-300 hover:shadow-md hover:-translate-y-1">
                  <h2 className="text-lg font-semibold mb-2 text-green-900 flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5 mr-2"
                      fill="none"
                  ...
                  <p className="text-green-800">{serviceItem.description}</p>
                </div>
              )}

              {serviceItem.openHours && (
                <div className="mb-6 bg-lime-500 bg-opacity-40 p-4 rounded-2xl shadow-lg backdrop-blur-sm transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                  <h2 className="text-lg font-semibold mb-2 text-green-900 flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="text-green-800 bg-lime-600 bg-opacity-30 p-3 rounded-xl">{serviceItem.openHours}</p>
                </div>
              )}
              ...
              {serviceItem.directionLink && (
                <div className="mb-6 bg-lime-500 bg-opacity-50 p-4 rounded-lg border border-green-700 transform transition-all duration-300 hover:shadow-md hover:-translate-y-1">
                  ...
                  <a
                    ...
                    className="text-green-900 hover:text-green-800 transition-colors duration-300 flex items-center group font-medium"
                  >
                    Get Directions
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              {/* Tags */}
              <div className="mt-6">
                <h2 className="text-lg font-semibold mb-3 text-green-900 flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 mr-2"
                    fill="none"
                ...
                {tags && tags.length > 0 ? (
                  ...
                  <p className="text-green-800 bg-lime-500 bg-opacity-50 p-3 rounded-lg border border-green-700">
                    No tags available
                  </p>
                )}
              </div>
        ...
        <div className="mt-8 text-center text-green-900 bg-lime-500 bg-opacity-30 p-4 rounded-2xl shadow-lg">
          <p className="italic">More details and features coming soon!</p>
        </div>
