...
export async function POST(req, { params }) {
  try {
    ...
    const leisureItem = await prisma.leisureItem.findUnique({ where: { id: parseInt(id) } });
    ...
    return NextResponse.json({ error: "Failed to associate tag with leisure item", details: error.message }, { status: 500 });
  }
}
