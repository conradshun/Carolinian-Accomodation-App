    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-green-900 via-green-800 to-green-700 flex justify-center items-center">
        <div className="relative">
          <div className="w-20 h-20 border-4 border-yellow-300 border-t-yellow-500 rounded-full animate-spin"></div>
          <div className="absolute top-0 left-0 w-20 h-20 border-4 border-transparent border-t-yellow-400 rounded-full animate-spin-slow"></div>
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mt-6 flex justify-center">
            <Link
              ...
              className="bg-gradient-to-r from-yellow-500 to-yellow-400 text-green-900 px-6 py-3 rounded-full hover:from-yellow-400 hover:to-yellow-300 transition duration-300 shadow-lg transform hover:-translate-y-1 hover:shadow-xl flex items-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="min-h-screen bg-gradient-to-b from-green-900 via-green-800 to-green-700">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center bg-gradient-to-r from-green-800 to-green-700 p-8 rounded-xl shadow-lg border border-green-600">
            ...
            <Link
              href="/food_places/food_items"
              className="bg-gradient-to-r from-yellow-500 to-yellow-400 text-green-900 px-6 py-3 rounded-full hover:from-yellow-400 hover:to-yellow-300 transition duration-300 shadow-lg inline-flex items-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5 mr-2"
          ...
          <div className="md:flex">
            <div className="md:w-1/2 relative overflow-hidden group">
              ...
              <button
                ...
                className="absolute top-4 right-4 p-3 bg-yellow-500 bg-opacity-80 rounded-full shadow-md hover:bg-opacity-100 transition-all transform hover:scale-110 hover:rotate-12 z-10"
                aria-label={isFavorite(Number.parseInt(id)) ? "Remove from favorites" : "Add to favorites"}
              >
                {isFavorite(Number.parseInt(id)) ? (
                  <span className="text-green-900 text-2xl animate-pulse">♥</span>
                ) : (
                  <span className="text-green-900 text-2xl hover:text-green-700">♡</span>
                )}
              </button>
            </div>
            ...
            <div className="p-6 md:w-1/2 relative">
              ...
              <h1 className="text-3xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-yellow-200">
                {foodItem.name}
              </h1>
              ...
              {/* Tags */}
              <div className="mt-6">
                <h2 className="text-lg font-semibold mb-3 text-yellow-300 flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 mr-2"
                    fill="none"
                  ...
                  <div className="flex flex-wrap gap-2">
                    {tags.map((tag) => (
                      <span
                        ...
                        className="bg-gradient-to-r from-yellow-500 to-yellow-400 text-green-900 px-3 py-1 rounded-full text-sm border border-yellow-400 transform transition-transform hover:scale-105 hover:-rotate-2"
                      >
                        {tag.name || "Unknown"}
                      </span>
                    ))}
              ...
              <div className="mt-8 flex justify-end">
                <button
                  ...
                  className="bg-gradient-to-r from-yellow-500 to-yellow-400 text-green-900 px-4 py-2 rounded-full hover:from-yellow-400 hover:to-yellow-300 transition duration-300 shadow-md hover:shadow-lg transform hover:scale-105 flex items-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
