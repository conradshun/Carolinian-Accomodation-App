...
export default function LeisureItemDetails() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-green-800 via-lime-700 to-lime-600 flex justify-center items-center">
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-green-800 via-lime-700 to-lime-600">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mt-6 flex justify-center">
            <Link
              href="/leisure_places/leisure_items"
  ...
  if (!leisureItem) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-green-800 via-lime-700 to-lime-600">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center bg-gradient-to-r from-green-700 to-lime-600 p-8 rounded-xl shadow-lg border border-lime-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="text-2xl text-green-100 mb-4">Leisure activity not found.</p>
            <p className="text-green-200 mb-6">
              The activity you're looking for may have been removed or doesn't exist.
            </p>
            <Link
              href="/leisure_places/leisure_items"
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 backdrop-blur-xl bg-gradient-to-b from-green-800 via-lime-700 to-lime-600 bg-opacity-60"></div>
      ...
      <div className="relative container mx-auto px-4 py-8 z-10">
        ...
        <div className="bg-gradient-to-br from-green-700 to-lime-600 rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-500 hover:shadow-2xl">
          <div className="md:flex">
            <div className="md:w-1/2 relative overflow-hidden group">
              {imageSrc ? (
                ...
                <div className="w-full h-64 md:h-full flex items-center justify-center bg-green-800">
                  <span className="text-green-400">No image available</span>
                </div>
              )}
              <div className="absolute inset-0 bg-gradient-to-t from-green-800 to-transparent opacity-40"></div>
              <button
            ...
            <div className="p-6 md:w-1/2 relative">
              ...
              <h1 className="text-4xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-lime-300 animate-pulse-slow">
                {leisureItem.name}
              </h1>

              {leisureItem.description && (
                <div className="mb-6 bg-green-600 bg-opacity-50 p-4 rounded-lg border border-lime-500 transform transition-all duration-300 hover:shadow-md hover:-translate-y-1">
                  ...
                  <p className="text-green-100">{leisureItem.description}</p>
                </div>
              )}

              {leisureItem.openHours && (
                <div className="mb-6 bg-green-600 bg-opacity-40 p-4 rounded-2xl shadow-lg backdrop-blur-sm transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                  <h2 className="text-lg font-semibold mb-2 text-yellow-300 flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="text-green-100 bg-green-700 bg-opacity-30 p-3 rounded-xl">{leisureItem.openHours}</p>
                </div>
              )}
              ...
              <div className="mt-6">
                ...
                {tags && tags.length > 0 ? (
                  <div className="flex flex-wrap gap-2">
                    {tags.map((tag) => (
                      <span
                        ...
                        className="bg-gradient-to-r from-green-600 to-green-500 text-yellow-300 px-3 py-1 rounded-full text-sm border border-green-500 transform transition-transform hover:scale-105 hover:-rotate-2"
                      >
                        {tag.name || "Unknown"}
                      </span>
                    ))}
                  ...
                  <p className="text-green-300 bg-green-600 bg-opacity-50 p-3 rounded-lg border border-lime-500">
                    No tags available
                  </p>
                )}
              </div>
