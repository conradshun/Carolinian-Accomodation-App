    ...
    <div className="min-h-screen bg-gradient-to-b from-green-900 via-green-800 to-green-700 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {/* Name Search */}
          <div className="bg-gradient-to-br from-green-800 to-green-700 p-6 rounded-xl shadow-lg border border-green-600 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            {searchResults.length > 0 && (
              <div className="mt-4">
                ...
                <ul className="bg-green-700 bg-opacity-50 p-4 rounded-lg border border-green-600">
        ...
        {/* Favorites Filter */}
        <div className="bg-gradient-to-r from-green-800 to-green-700 p-6 rounded-xl shadow-lg mb-8 border border-green-600 transform transition-all duration-300 hover:shadow-xl">
            ...
            <button
              ...
              className={`px-6 py-3 rounded-full transition duration-300 flex items-center transform hover:scale-105 ${
                showingFavorites
                  ...
                  : "bg-gradient-to-r from-green-700 to-green-600 text-green-100 hover:from-green-600 hover:to-green-500 shadow-md hover:shadow-lg"
              }`}
          ...
          {favorites.length === 0 && (
            <div className="text-green-100 mt-4 bg-green-700 bg-opacity-50 p-4 rounded-lg border border-green-600 flex items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              You haven't added any favorites yet. Click the heart icon on any food place to add it to your favorites!
            </div>
          )}
        </div>
        ...
        <div className="mb-8">
          ...
          {isLoading ? (
            ...
            <div className="text-center text-green-100 bg-gradient-to-r from-green-800 to-green-700 p-8 rounded-xl shadow-lg border border-green-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
...
function FoodItem({ item }) {
  ...
  return (
    <div className="bg-gradient-to-br from-green-800 to-green-700 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-500 border border-green-600 transform hover:-translate-y-2 hover:scale-102 group card-hover">
      <div className="relative">
        <Link href={`/food_places/food_items/${item.id}`}>
          <div className="h-48 bg-green-900 relative overflow-hidden group-hover:h-52 transition-all duration-500">
            {imageSrc ? (
              <img
        ...
        <button
          ...
          className="absolute top-3 right-3 p-3 bg-green-900 bg-opacity-80 rounded-full shadow-md hover:bg-opacity-100 transition-all transform hover:scale-110 hover:rotate-12 z-10"
