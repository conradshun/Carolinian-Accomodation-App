...
export default function FoodItemDetails() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-yellow-400 via-yellow-300 to-yellow-200 flex justify-center items-center">
  ...
  if (!foodItem) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-yellow-400 via-yellow-300 to-yellow-200">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center bg-gradient-to-r from-yellow-500 to-yellow-400 p-8 rounded-xl shadow-lg border border-green-700">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="text-2xl text-green-900 mb-4">Food place not found.</p>
            <p className="text-green-800 mb-6">
              The food place you're looking for may have been removed or doesn't exist.
            </p>
            <Link
              href="/food_places/food_items"
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 backdrop-blur-xl bg-gradient-to-b from-yellow-400 via-yellow-300 to-yellow-200 bg-opacity-60"></div>
      ...
      <div className="relative container mx-auto px-4 py-8 z-10">
        <div className="flex justify-between items-center mb-6">
          <div className="flex gap-4">
            ...
            <Link
              href="/food_places/food_items"
              className="bg-gradient-to-r from-yellow-500 to-yellow-400 text-green-900 px-6 py-3 rounded-full hover:from-yellow-400 hover:to-yellow-300 transition duration-300 shadow-lg font-medium transform hover:-translate-y-1 hover:shadow-xl flex items-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5 mr-2"
        ...
        <div className="bg-gradient-to-br from-yellow-500 to-yellow-400 rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-500 hover:shadow-2xl">
          <div className="md:flex">
            <div className="md:w-1/2 relative overflow-hidden group">
              {imageSrc ? (
                ...
                <div className="w-full h-64 md:h-full flex items-center justify-center bg-yellow-600">
                  <span className="text-yellow-300">No image available</span>
                </div>
              )}
              <div className="absolute inset-0 bg-gradient-to-t from-yellow-600 to-transparent opacity-40"></div>
              <button
            ...
            <div className="p-6 md:w-1/2 relative">
              ...
              <h1 className="text-4xl font-bold mb-4 text-green-900 animate-pulse-slow">{foodItem.name}</h1>

              {foodItem.description && (
                <div className="mb-6 bg-yellow-400 bg-opacity-50 p-4 rounded-lg border border-green-700 transform transition-all duration-300 hover:shadow-md hover:-translate-y-1">
                  ...
                  <p className="text-green-800">{foodItem.description}</p>
                </div>
              )}

              {foodItem.openHours && (
                <div className="mb-6 bg-yellow-400 bg-opacity-40 p-4 rounded-2xl shadow-lg backdrop-blur-sm transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                  <h2 className="text-lg font-semibold mb-2 text-green-900 flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="text-green-800 bg-yellow-500 bg-opacity-30 p-3 rounded-xl">{foodItem.openHours}</p>
                </div>
              )}
              ...
              <div className="mt-6">
                ...
                {tags && tags.length > 0 ? (
                  ...
                  <p className="text-green-800 bg-yellow-400 bg-opacity-50 p-3 rounded-lg border border-green-700">
                    No tags available
                  </p>
                )}
              </div>
